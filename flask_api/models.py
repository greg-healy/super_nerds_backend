...
class Users(db.Model):
    ...
    user_transactions = db.relationship('UsersTransactions', backref='users', uselist=False)
...
class Transactions(db.Model):
    ...
    # One to many
    user_transactions = db.relationship('UsersTransactions', backref='transactions', uselist=False)
